...
typedef struct {
  ...
  int nSLEEP_M1;     // Pin nSLEEP del MOTOR 1 (-1 si está conectado permanentemente a 3.3V/5V)
  int DISABLE_M1;    // Pin DISABLE del MOTOR 1 (-1 si está conectado permanentemente a GND)
  ...
  int nSLEEP_M2;     // Pin nSLEEP del MOTOR 2 (-1 si está conectado permanentemente a 3.3V/5V)
  int DISABLE_M2;    // Pin DISABLE del MOTOR 2 (-1 si está conectado permanentemente a GND)
