...
#define ARDUCAM_PIN_MISO  4
#define ARDUCAM_PIN_MOSI  5
#define ARDUCAM_PIN_SCK   6
#define ARDUCAM_PIN_CS    7

#define ARDUCAM_PIN_SDA   8
#define ARDUCAM_PIN_SCL   9
...
// set slave select for ArduCAM
const int CS = ARDUCAM_PIN_CS;
...
uint8_t temp;
  ...
  Serial.begin(921600);
  delay(500);
  Wire.begin(ARDUCAM_PIN_SDA, ARDUCAM_PIN_SCL);
...
// initialize SPI:
SPI.begin(ARDUCAM_PIN_SCK, ARDUCAM_PIN_MISO, ARDUCAM_PIN_MOSI, ARDUCAM_PIN_CS);
  //Reset the CPLD
...
while(1){
  ...
  while(1){
    ...
    Serial.print(F("Checking OV2640 -> VID: 0x"));
